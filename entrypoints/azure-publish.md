...
```text
/ftd-azure-publish --run "<run>" --prepare --organization <url> --project <id|name> --plan <id|name> [--root-suite <id|name>] --auth <azure-cli|interactive|env:VARIABLE>
